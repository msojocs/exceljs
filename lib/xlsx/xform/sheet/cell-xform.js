...
class CellXform extends BaseXform {
  ...
  prepare(model, options) {
    ...
    switch (model.type) {
      ...
      case Enums.ValueType.Hyperlink:
        ...
        if (options.sharedStrings && model.richText !== undefined && model.richText !== null) {
  ...
  reconcile(model, options) {
    ...
    if (hyperlink) {
      ...
      if(hyperlink.type === 'internal')
        model.location = hyperlink.value;
      else
        model.hyperlink = hyperlink.value;
    }
