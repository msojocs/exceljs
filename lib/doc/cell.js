...
class HyperlinkValue {
  constructor(cell, value) {
    ...
    if(value){
      ...
      if(value.richText)
        this.model.richText = value.richText;
      if(value.hyperlink)
        this.model.hyperlink = value.hyperlink;
      if(value.location)
        this.model.location = value.location;
    }
  ...
  get value() {
    const v = {};
    if(this.model.text)
      v.text = this.model.text;
    if(this.model.richText)
      v.richText = this.model.richText;
    if(this.model.hyperlink)
      v.hyperlink = this.model.hyperlink;
    if(this.model.location)
      v.location = this.model.location;
...
const Value = {
  getType(value) {
    ...
    if ((value.text || value.richText) && (value.hyperlink || value.location)) {
      return Cell.Types.Hyperlink;
    }
